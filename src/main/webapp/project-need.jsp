...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center"><a href='${pageContext.request.contextPath}/anal/detail/${analysis.id}'>${analysis.proname}</a></td>
	<td>
	...
	<td><a href="${pageContext.request.contextPath}/anal/edit/${analysis.id}">编辑</a> | <a href="${pageContext.request.contextPath}/anal/detail/${analysis.id}">查看详情</a></td>
</tr>
</c:forEach>
