...
<li><a href='${pageContext.request.contextPath}/pro/getProjects' target='main'>基本信息管理</a> </li>
<li><a href='${pageContext.request.contextPath}/anal/getAnals' target='main'>需求分析管理</a> </li>
<li><a href='project-model.jsp' target='main'>模块管理</a> </li>
<li><a href='project-function.jsp' target='main'>功能管理</a> </li>
<li><a href='${pageContext.request.contextPath}/attachment/getAttachments' target='main'>附件管理</a> </li>
</ul>
</dd>
</dl>
...
<li><a href='${pageContext.request.contextPath}/baoxiao/list?pageNum=1' target='main'>我的报销</a> </li>
<li><a href='new-forum.jsp' target='main'>发布新帖</a> </li>
</ul></dd></dl>
...
<li><a href='echarts.jsp' target='main'>数据统计</a> </li>
</ul></dd></dl> 
