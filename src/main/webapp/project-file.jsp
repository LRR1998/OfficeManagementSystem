...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>${index.count}</td>
	<td>${analysis.attname}</td>
	<td align="center"><a href=''>${analysis.proname}</a></td>
	<td>3</td>
	<td>
        2013-01-01
    </td>
	<td>2015-06-03</td>
	<td><a href="${pageContext.request.contextPath}/attachment/download?path=${analysis.path}&attname=${analysis.attname}">下载</a> |<a href="#">删除</a> |<a href="project-file-edit.jsp">编辑</a> | <a href="project-file-look.jsp">查看详情</a></td>
</tr>
</c:forEach>
