...
<script type="text/javascript">
	function change() {
		$("#code").attr("src","${pageContext.request.contextPath}/code/getCode?time="+new Date());
	}
</script>
</HEAD>
					...
					<TD background=images/crm_12.gif colSpan=6>
						<TABLE id=table1 cellSpacing=0 cellPadding=0 width="98%" border=0>
							<TBODY>
								<TR>
									<TD>
										<form id="formlog" action="emp/login" method="post">
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16  name="username" value="lrr" id=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 name="password" value=123 id=password></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD>
														<INPUT class=regtxt autocomplete="off" title=请填写验证码 maxLength=8 size=8 id="validate"  name=validate>
													</TD>
												</TR>
												<tr>
													<td colspan="2">
														<img onclick="change()" id="code" src="${pageContext.request.contextPath}/code/getCode?time=false" alt="">
													</td>
												</tr>
											</TBODY>
										</TABLE>
