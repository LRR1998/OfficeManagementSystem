...
<script type="text/javascript">
    ...
    function reverse() {
        $("#list-table input").each(function () {
            var checked = $(this).prop("checked",!($(this).prop("checked")));
        });
    }
        ...
        if (confirm("您确定要删除吗?")){
            ...
            $.ajax({
                ...
                success:function (msg) {
                    if (msg.status==200){
                        alert(msg.message);
                        window.location="${pageContext.request.contextPath}/cust/list";
                    } else {
                        alert(msg.message);
                        window.location="${pageContext.request.contextPath}/cust/list";
                    }
    ...
    function importExcel() {
        ...
        var result = setInterval(function () {
            ...
            if (file!=undefined){
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/cust/uploadExcel",
                    cache:false,
                    processData:false,
                    contentType:false,
                    data:formData,
  ...
  <tr bgcolor='#EEF4EA'>
    <td background='skin/images/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        ...
        <td>
          &nbsp;&nbsp;&nbsp;<input onclick="submit" name="imageField" type="image" src="${pageContext.request.contextPath}/skin/images/frame/search.gif" width="45" height="20" border="0" class="np" />
        </td>
       </tr>
      </table>
    </td>
...
<c:forEach items="${customers}" var="cust" varStatus="index">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>${cust.comphone}</td>
	<td><a href="${pageContext.request.contextPath}/cust/edit/${cust.id}">编辑</a> |
        <a href="${pageContext.request.contextPath}/cust/detail/${cust.id}">查看详情</a></td>
</tr>
</c:forEach>
...
<td height="28" colspan="12">
	...
	<a href="${pageContext.request.contextPath}/cust/getExcel" class="coolbg">&nbsp;导出Excel&nbsp;</a>
    <span id="uploadImg" class="coolbg">
