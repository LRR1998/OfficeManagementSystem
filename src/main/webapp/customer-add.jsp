...
<form id="form2" action="${pageContext.request.contextPath}/cust/saveInfo" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="comphone" name="comphone"/><span id="phoneInfo"></span></td>
</tr>
<tr >
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<a href="javascript:void(0)" onclick="commit()" class="coolbg">保存</a>
...
<script type="text/javascript">
    function commit() {
		...
		if (phone==null||phone==""){
			$("#phoneInfo").text("联系电话不能为空!").css("color","red");
			return;
		}
        if (!(/^1[3456789]\d{9}$/.test(phone))) {
            ...
            $.ajax({
                type:"post",
				url:"${pageContext.request.contextPath}/cust/checkPhone",
				data:{"phone":phone},
				dataType:"json",
                success:function(isRegist){
                    if (isRegist) {
                        $("#phoneInfo").text("该手机号已被使用").css("color","red");
                    	return;
                    } else {
                        $("#form2").submit();
                    }
