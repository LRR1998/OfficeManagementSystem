...
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/static/My97DatePicker/WdatePicker.js"></script>
	...
	function changeLeader(id) {
		$.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/cust/leader",
			data:{"id":id},
			success:function (msg) {
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="cusList" name="comname" onchange="changeLeader(this.value)">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" id="leader" name="comper" readonly/></td>
...
<tr >
	...
	<td align='left'  bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" class="Wdate" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd','minDate':'%y-%M-%d'})" name="starttime"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">立项时间：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" class="Wdate" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd','minDate':'%y-%M-%d'})" name="buildtime"/></td></td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" class="Wdate" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd','minDate':'%y-%M-%d'})" name="endtime"/></td></td>
</tr>
