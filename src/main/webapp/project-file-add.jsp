...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        $(function () {
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/pro/getJsonList",
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/attachment/saveInfo" method="post" enctype="multipart/form-data">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="attFile" type="file"/></td>
</tr>
