...
<base href="${pageContext.request.contextPath}/">
    <form action="${pageContext.request.contextPath}/forum/saveInfo" method="post">
        标题：<input type="text" name="forumtitle" placeholder="帖子标题"><br/>
        内容：<script id="editor" name="forumcontent" type="text/plain" style="width:1024px;height:500px;"></script>
